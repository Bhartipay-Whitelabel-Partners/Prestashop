...
<div class="loader">
    <img src="https://www.pg.com/wp-content/uploads/2018/07/logo.png" class="centre-image">
</div>  
...
class PGValidationModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        //$merchant_website=$merchant_website."en/module/pg/validation";
        $merchant_website=$merchant_website."en/module/pg/thankyou";
        //test for redirect
       ...
       // @$pg_transaction->setCustShipName($_REQUEST['CUST_SHIP_NAME']);
        ...
        $this->setTemplate('module:pg/views/templates/front/payment_return.tpl');
