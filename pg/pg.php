...
class PG extends PaymentModule
{
    protected $_html = '';
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Pg Payment Gateway');
        $this->description = $this->l('If you are looking for a reliable online payment partner, head towards PG, we offer 100+ Payment options. Easy to integrate with your website with tons of ready-to-go plugins for major open source ecommerce.');
    ...
    public function displayForm()
{
    ...
    public function getExternalPaymentOption()
    {
        ...
        $externalOption->setCallToActionText($this->l('Pay By PG'))
    ...
    protected function generateForm()
    {
        ...
        return $this->context->smarty->fetch('module:pg/views/templates/front/payment_form.tpl');
    }
}
